...
class ExprNode
{
    ...
    virtual int toInstruction(Instruction* prog[], int& progEnd, int& tempCounter, VarTree& v) const = 0;
};
...
class Value: public ExprNode
{
    ...
    public:
        ...
        string makedc() const;
        int toInstruction(Instruction* prog[], int& progEnd, int& tempCounter, VarTree& v) const;
};
